"""
Django settings for simplestory project.
...
# SECRET_KEY='a)^0a_%m7)08c^em(^3&&+ki4z1g1w7u5x0ubq*jd=cz^@7+=_'
...
WSGI_APPLICATION = 'simplestory.wsgi.application'
