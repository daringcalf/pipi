...
class SiteUserAdminCreationForm(forms.ModelForm):
    ...
    password1 = forms.CharField(label='Password', widget=forms.PasswordInput, max_length=12)
    password2 = forms.CharField(label='Password confirmation', widget=forms.PasswordInput, max_length=12)
